...
from tools.binidx import MMapIndexedDataset
from tools.rwkv_tokenizer import TRIE_TOKENIZER
...
class Jsonl2Binidx:
    ...
    def __init__(self, jsonl_file: str, n_epoch: int, output_path: str, context_len: int=1024):
        ...
        self.tokenizer = TRIE_TOKENIZER("src/tools/rwkv_vocab_v20230424.txt")
