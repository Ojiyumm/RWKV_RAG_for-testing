...
if 'x060' in os.environ["RWKV_MY_TESTING"]:
    rwkv6 = load(name="rwkv6", sources=["cuda/rwkv6_op.cpp", "cuda/rwkv6.cu"],
...
from .logits_processors import TopKLogitsProcess,TopPLogitsProcess,RepetitionPenaltyLogitsProcessor
