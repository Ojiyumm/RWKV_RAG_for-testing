...
class IndexClient:
    ...
    def delete_collection(self,collection_name=None):
        ...
        resp = msgpack.unpackb(msg, raw=False)
        return resp
    def search_nearby(self,text,collection_name=None):
...
if __name__ == '__main__':
    ...
    print(index_client.delete_collection('new_collection'))
    print(index_client.show_collection())
    #collection_name='initial'
    #print(index_client.index_texts(["大家好","我来自北京"],collection_name='initial'))
    #print(index_client.index_texts(["你好","小猫咪真可爱"],collection_name))
    #print(index_client.index_texts(["User: 我有一个数学表达式，请为我算出结果。\nBot: 好的。请出题。\nUser:(25-8)*12\nBot:"],collection_name))
    #print(index_client.index_texts(["美丽突额隆头鱼（学名：Semicossyphus pulcher）是东太平洋特有的一种隆头鱼科鱼类，分布于美国加利福尼亚州的蒙特利湾至墨西哥的加利福尼亚湾。[2]美丽突额隆头鱼为日行性肉食鱼类，主要猎物为各种底栖无脊椎动物。其和其他隆头鱼科物种一样是雌性先熟顺序性雌雄同体，即所有鱼出生时均为雌性，后可能转变为雄性。此外，该鱼也可食用。 "],collection_name))
